...
import { FiCheck, FiSun, FiShield, FiMaximize } from 'react-icons/fi';
import ContactSection from './ContactSection';

const WoodAluminumWindowsPageContent = () => {
    return (
            ...
            <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-slate-900">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Finestra in legno-alluminio"
                        fill
                        sizes="100vw"
                ...
                <div className="container">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <motion.div
                            ...
                            className="relative"
                        >
                            <div className="absolute inset-0 bg-amber-500/10 rounded-3xl transform rotate-3 z-0"></div>
                            <Image
...
export default WoodAluminumWindowsPageContent;
