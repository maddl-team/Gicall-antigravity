                        ...
                        >
                            <div className="grid grid-cols-2 gap-4">
                                <div className="relative w-full h-64 rounded-lg overflow-hidden shadow-lg">
                                    <Image
                                        src="/images/gicall_pvc-legno_1.webp"
                                        alt="Finestra effetto legno"
                                        fill
                                        sizes="(max-width: 768px) 50vw, 25vw"
                                        className="object-cover"
                                    />
                                </div>
                                <div className="relative w-full h-64 rounded-lg overflow-hidden shadow-lg mt-8">
                                    <Image
                                        src="/images/gicall_pvc-legno_2.webp"
                                        alt="Finestra moderna scura"
                                        fill
                                        sizes="(max-width: 768px) 50vw, 25vw"
                                        className="object-cover"
                                    />
...
export default PvcWindowsPageContent;
