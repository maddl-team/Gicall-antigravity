...
import { FiShield, FiHome, FiZap, FiSmartphone, FiHelpCircle } from 'react-icons/fi';
import ContactSection from './ContactSection';

const RollerShuttersPageContent = () => {
    return (
        <div className="bg-white">
            ...
            <section className="relative min-h-screen md:min-h-[70vh] flex items-center justify-center overflow-hidden bg-slate-900">
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/gicall_avvolgibili_cassonetti_slide.webp"
                        alt="Avvolgibili e cassonetti"
                        fill
                        sizes="100vw"
...
export default RollerShuttersPageContent;
