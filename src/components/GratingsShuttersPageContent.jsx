...
const GratingsShuttersPageContent = () => {
    return (
        <div className="bg-white">
            ...
            <section className="relative min-h-screen md:min-h-[70vh] flex items-center justify-center overflow-hidden bg-slate-900">
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/gicall_grate_persiane_slide.webp"
                        alt="Grate e persiane di sicurezza"
                        fill
                        sizes="100vw"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <Image
                                ...
                                alt="Dettaglio grate e persiane"
                                fill
...
export default GratingsShuttersPageContent;
