...
const ServicesPage = () => {
    ...
    return (
        <div className="font-sans text-slate-900 antialiased selection:bg-amber-100 selection:text-amber-900">
            ...
            <title>Servizi GICALL | Progettazione, Posa Certificata e Assistenza - Roma e Orvieto</title>
            <meta name="description" content="Un servizio chiavi in mano. Dalla progettazione tecnica alla posa in opera qualificata, fino all'assistenza post-vendita e gestione pratiche fiscali. Affidati ai professionisti GICALL." />
            <meta name="keywords" content="Installazione Infissi Roma, Posa in Opera Serramenti, Assistenza Infissi, Progettazione Infissi, Bonus Fiscali Infissi" />
