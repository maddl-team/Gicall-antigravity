...
const SecurityDoorsPage = () => {
    return (
        <>
            <title>Porte Blindate su Misura | Sicurezza Classe 3 e 4 - GICALL</title>
            <meta name="description" content="Dormi sonni tranquilli con le porte blindate GICALL. Certificazione antieffrazione Classe 3 e 4, serrature europee e pannelli personalizzati. Scegli la sicurezza a Roma e Orvieto." />
            <meta name="keywords" content="Porte Blindate Roma, Portoncini di Ingresso Sicurezza" />
...
export default SecurityDoorsPage;
