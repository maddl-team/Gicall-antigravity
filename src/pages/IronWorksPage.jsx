...
import { FiShield, FiTool, FiGrid, FiLayers, FiZap, FiLayout, FiCheckCircle } from 'react-icons/fi';
...
const IronWorksPage = () => {
    return (
        <>
            <title>Lavorazioni in Ferro e Cancelli | Artigianato e Design su Misura - GICALL</title>
            <meta name="description" content="Produzione artigianale di cancelli, recinzioni e scale in ferro. Design classico e moderno a taglio laser. Zincatura a caldo e verniciatura a forno per una durata eterna. Roma e Orvieto." />
            <meta name="keywords" content="Lavorazioni in ferro Roma, Cancelli in ferro moderni, Recinzioni metalliche, Fabbro Roma, Ringhiere su misura" />
