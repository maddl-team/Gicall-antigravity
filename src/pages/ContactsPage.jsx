...
const ContactsPage = () => {
    ...
    const locations = [
        {
            ...
            address: "Via [Indirizzo Completo], Capena (RM)",
            phone: "+39 [Numero Fisso]",
            mobile: "+39 [Cellulare]",
            email: "roma@gicall.it",
            directions: "A pochi minuti dall'uscita autostradale, comodo parcheggio riservato ai clienti.",
            mapEmbed: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2969.0!2d12.5!3d42.1!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDLCsDA2JzAwLjAiTiAxMsKwMzAnMDAuMCJF!5e0!3m2!1sit!2sit!4v1234567890"
        },
        {
            name: "SEDE ORVIETO",
            subtitle: "Showroom",
            description: "Il nostro punto di riferimento per l'Umbria e l'Alto Lazio.",
            address: "Via [Indirizzo Completo], Orvieto (TR)",
            phone: "+39 [Numero Fisso]",
            mobile: null,
            email: "orvieto@gicall.it",
            directions: "Situato in [Zona specifica], facile da raggiungere dal centro.",
            mapEmbed: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2969.0!2d12.1!3d42.7!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDLCsDA2JzAwLjAiTiAxMsKwMzAnMDAuMCJF!5e0!3m2!1sit!2sit!4v1234567890"
        }
    ];

    const schedule = [
        { day: "Lunedì", morning: "09:00 - 13:00", afternoon: "15:00 - 19:00" },
        { day: "Martedì", morning: "09:00 - 13:00", afternoon: "15:00 - 19:00" },
        { day: "Mercoledì", morning: "09:00 - 13:00", afternoon: "15:00 - 19:00" },
        { day: "Giovedì", morning: "09:00 - 13:00", afternoon: "15:00 - 19:00" },
        { day: "Venerdì", morning: "09:00 - 13:00", afternoon: "15:00 - 19:00" },
        { day: "Sabato", morning: "09:00 - 13:00", afternoon: "Su appuntamento" },
    ...
    return (
        <div className="font-sans text-slate-900 antialiased selection:bg-amber-100 selection:text-amber-900">
            ...
            <title>Contatti GICALL | Showroom Roma e Orvieto - Preventivi e Assistenza</title>
            <meta name="description" content="Parla con i tecnici GICALL. Visita i nostri showroom a Capena (Roma) e Orvieto. Richiedi un preventivo gratuito o assistenza tecnica. Chiama ora." />
            <meta name="keywords" content="Contatti GICALL, Showroom Infissi Roma, Showroom Infissi Orvieto, Preventivi Infissi, Assistenza Infissi" />
                                    ...
                                    <div className="p-8">
                                        ...
                                        <div className="bg-amber-50 p-4 rounded-lg mb-6">
                                            <p className="text-sm text-slate-700">
                                                <strong>Come raggiungerci:</strong> {location.directions}
                                            </p>
                                        </div>
                                    </div>
